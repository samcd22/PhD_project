...
class BoxGridder:
    ...
    def get_averages(self, grid_size, target = False, conc_column_name = 'Norm_Conc'):
        ...
        for i in range(self.data.shape[0]):
            ...
            self.samples[indices[idx][0],indices[idx][1],indices[idx][2]].append(conc)
        ...
        averaged_df = pd.DataFrame({'x':centroid_x,'y':centroid_y,'z':centroid_z,'Concentration':averages_data, 'Counts': counts_data})
