class DataProcessor:
    """
    A class to define the data processor. This is a base class that is inherited by the specific data processors: RawDataProcessor and SimDataProcessor.
    ...
    def __init__(self, processed_data_name: str, processor_params: dict, train_test_split: float = 0.8, data_path = '/data'):
        """
